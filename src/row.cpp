...
int row::getNumOfBlacks() { return numOfBlack; }

int row::getNumOfWhites() { return numOfWhite; }
...
void row::incrementWhite() { numOfWhite++; }

void row::incrementBlack() { numOfBlack++; }

void row::decrementWhite() { numOfWhite--; }

void row::decrementBlack() { numOfBlack--; }
